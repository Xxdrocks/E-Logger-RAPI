...
function OperatorPage() {
    ...
    const fetchStats = async () => {
        try {
            ...
            console.error('Error fetching website lock status:', error);
        }
    };
                            ...
                            <div className="flex flex-col gap-3.5">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="admin">Kordinator</option>
            ...
            {showImportModal && (
                <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[200] flex items-center justify-center p-6">
                    <div className="bg-white rounded-2xl p-8 w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        {importResult && (
                            <div className={`rounded-xl p-4 mb-6 ${importResult.success
                                ? 'bg-green-50 border border-green-200'
                                : 'bg-red-50 border border-red-200'
                                }`}>
                                <h3 className={`font-bold mb-2 text-sm ${importResult.success ? 'text-green-900' : 'text-red-900'
                                    }`}>
                                    {importResult.success ? '✓ Import Berhasil' : '✗ Import Gagal'}
                                </h3>
                                <p className={`text-xs mb-2 ${importResult.success ? 'text-green-800' : 'text-red-800'
                                    }`}>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-white/90">
                                {remainingTime
                                    ? `Member tidak dapat mengakses LogPage. Akan terbuka otomatis pada ${new Date(remainingTime).toLocaleString('id-ID')}`
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className={`px-5 py-2.5 rounded-xl font-bold shadow-md hover:shadow-lg transition-all flex items-center gap-2 text-sm ${websiteLocked
