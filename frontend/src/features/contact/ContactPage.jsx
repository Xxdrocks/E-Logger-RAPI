...
function ContactPage() {
    const whatsappNumber = '6285855172473';
...
{/* 
                <div className="mt-12 text-center">
                    <h3 className="text-xl font-bold text-slate-900 mb-6">Ikuti Kami</h3>
                    <div className="flex justify-center gap-4">
                        <a
                            href="https://facebook.com/rapi"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-600 hover:bg-blue-600 hover:text-white transition-all shadow-md hover:shadow-lg hover:-translate-y-1"
                        >
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a
                            href="https://instagram.com/rapi"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-pink-600 hover:bg-pink-600 hover:text-white transition-all shadow-md hover:shadow-lg hover:-translate-y-1"
                        >
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a
                            href="https://twitter.com/rapi"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-sky-500 hover:bg-sky-500 hover:text-white transition-all shadow-md hover:shadow-lg hover:-translate-y-1"
                        >
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
